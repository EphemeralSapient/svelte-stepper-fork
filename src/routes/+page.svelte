...
<div class="wrapper">
  <div class="logo">
    <a class="typo-header-3" href="https://github.com/efstajas/svelte-stepper" target="_blank"
      >Svelte Stepper</a
    >
  </div>
  <div class="modal">
    <ProgressBar
      max={stepsMaxIndex}
      curr={currIndex}
      duration={$context?.defaultTransitionDuration}
    />
  ...
  <div class="credits">
    ...
    <a class="typo-text-small" href="https://github.com/efstajas/svelte-stepper" target="_blank"
      >Svelte Stepper on GitHub</a
    >
  </div>
</div>
